        ...
        <form action="/submit-form" method="post">
            <div class="member-info">
                ...
                <div class="compensation-form-group">
                    ...
                    <!-- store Name -->
                    <div>
                        <label for="store-name"><span>証券番号〈タイヤ〉
                            </span><span class="must">必 須</span></label>
                        <input type="text" id="store-name" name="store-name" required placeholder="平塚店"
                            class="store-name-custom">
                    </div>

                    <!-- charge name -->
                    <div>
                        <label for="charge-name"><span>証券番号〈ホイール〉
                            </span><span class="must">必 須</span></label>
            ...
            <div class="accident-info">
                ...
                <div class="accident-form-group">
                    <label for="incidentDescription"><span>事故状況
                        </span><span class="must">必 須</span></label>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <span>
                                    <input type="checkbox" name="" id="">有
                                </span>
                                <span>
                                    <input type="checkbox" name="" id="">無
                                </span>
                            </td>
                            <td>
                                <input type="text">
